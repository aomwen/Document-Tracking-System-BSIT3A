  ...
  $('#newprofile_form').on('submit',function(e){
    ...
    if($('#newprofile').val() == ''){
     ...
     var filename = $('#newprofile').val();
      ...
      var x = $("#newprofile_form").attr("action")  
...
//EDIT PASSWORD
 $('#newpassword_form').on('submit',function(e){
    ...
    if(($('#newpassword').val() != '') && ($('#confirmpassword').val() !='') && ($('#oldpassword').val() !='')){
      ...
      if(($('#newpassword').val() == $('#confirmpassword').val())&&($('#oldpassword').val() == oldpassword)){
    
        var npass=$('#newpassword').val();
        var cpass=$('#confirmpassword').val();
         var actionnewpassword_form = document.getElementById("newpassword_form").action;
        if((npass.length>5) && (cpass.length>5)){
            $.ajax({
              url:actionnewpassword_form, 
              method:"POST",
              data:new FormData(this),
              contentType:false,
              cache:false,
...
$(document).ready(function() {
   $('#save_edit').on('submit',function(e){
        ...
        if (validateEmail(email)) {
         ...
         var actionuserinfo = document.getElementById("save_edit").action;
            $.ajax({
		        url:actionuserinfo, 
		        method:"POST",
		        data:new FormData(this),
...
//NEW POSITION
  $('#newposition_form').on('submit',function(e){
    e.preventDefault();
    if($('#positionpos').val() == '' || $('#collegeIdpos').val() == ''){
    	alert("Please Fill in all the fields.");
    }else{

        	var addpos = document.getElementById("newposition_form").action;
    	  $.ajax({
	      url:addpos, 
	      method:"POST",
	      data:new FormData(this),
...
//ADD USER
    ...
    if($('#username').val() != '' && $('#firstname').val() != '' && $('#lastname').val() != '' && $('#email').val() != '' && $('#collegeId').val() != '' && $('#department').val() != '' && $('#position').val() != ''){
    	var email = $('#email').val();
        var useradd = document.getElementById("formUser").action;
        if (validateEmail(email)) {
          $.ajax({
          url:useradd, 
          method:"POST",
  ...
  $('#newCollege_form').on('submit',function(e){
    ...
    if($('#collegeId').val() != '' && $('#collegeName').val() != '' && $('#collegeDesc').val() != '' && $('#collegeDean').val() != ''){
	    if($('#collegeLogo').val() == ''){
	     ...
	     var filename = $('#newprofile').val();
	       var addCollegeAction = document.getElementById("newCollege_form").action;
	      	$.ajax({
	        url:addCollegeAction, 
	        method:"POST",
	        data:new FormData(this),
	        contentType:false,
	        cache:false,
	        ...
	        success:function(data){
				...
				document.getElementById('managecoll').click();
	        }
  ...
  // UPDATE COLLEGE PHOTO
  $('#collegeprofile_form').on('submit',function(e){
    e.preventDefault();
    if($('#newprofile').val() == ''){
      ...
      if(valid_extensions.test(filename))
      { 
      	var updateCollege = document.getElementById("collegeprofile_form").action;
         $.ajax({
          url:updateCollege, 
          method:"POST",
          data:new FormData(this),
          ...
          processData:false,
          success:function(data){
            alert("College has been Successfully UPDATED!");
		          location.href = document.URL;
          }
        });
      }
  ...
  //COLLEGE UPDATE INFO
  $(document).ready(function() {
     $('#collegeinfo').on('submit',function(e){
     		e.preventDefault();
          		var updateCollegeinfo = document.getElementById("collegeinfo").action;
              $.ajax({
  		        url:updateCollegeinfo, 
  		        method:"POST",
  		        data:new FormData(this),
  		        contentType:false,
  		        cache:false,
...
$(document).ready(function() {
   $('#forwardForm').on('submit',function(e){
   		e.preventDefault();
         var forwardAction = document.getElementById("forwardForm").action;
         alert(forwardAction);
            $.ajax({
		        url:forwardAction, 
		        method:"POST",
		        ...
		        processData:false,
		        success:function(data){
		          alert("Document has been successfully Forwarded!");
		        }
		    });  
     });
});