<div class="col-sm-9">
	<div class="panel panel-default">
		...
		<div class="col-sm-8" style="margin: auto;">
			...
			<input type="text" name="college_acronym" placeholder="COS" class="form-control" />
			</div>
			<div class="form-group">
			...
			<input type="text" name="college_desc" class="form-control" />
			</div>
			<div class="form-group">
			<label>College Dean:</label>
			<input type="text" name="college_dean" placeholder="Mwen" class="form-control" />
			</div>
			<div class="form-group">
