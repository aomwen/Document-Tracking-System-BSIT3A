								...
								<form>
									<div class="form-group row text-center">
										<div class="col-sm-6">
							            	...
							            	?>
							            		<a href="#" class="inboxbtn btn btn-danger" onClick="deleteSentMess('<?php echo $d['trackcode'];?>')" title="Delete">
							            			<span class="glyphicon glyphicon-trash"></span>
							            			<span class="font">Delete</span>
							            		</a>
											<?php echo '
												<a href="'.base_url('FilesManipulation/do_download/'.$d['trackcode']).'" class="inboxbtn btn btn-success" title="Download">
