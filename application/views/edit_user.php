	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			...
			foreach($username as $u){ 
				echo '
				<form method="post" action="'.base_url('ManageRegistrarDocu/UD_user').'">
					...
					<div class="form-group">
						...
						<input type="text" name="email_address" class="form-control" value="'.$u['email_address'].'"/>
					</div>';
					}?>
				<div class="form-group">
					<div class="dropdown">
						<label for="sel1">College/Office</label>
						<select class="form-control" id="sel1" name="college_acronym">
						<?php foreach($colleges as $c){
							echo '
							<option>'.$c['college_acronym'].'</option>';
						}?>
						</select>
					</div>
				</div>
