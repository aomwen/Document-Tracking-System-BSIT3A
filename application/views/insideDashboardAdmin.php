        ...
        <div class="right_col" role="main">
          ...
          <div class="row top_tiles">
            ...
            <div class="animated flipInY col-lg-3 col-md-3 col-sm-4 col-xs-12">
              <div class="tile-stats">
                <div class="icon"><i class="fa fa-file-o"></i></div>
                <a href="<?php echo base_url('ManageAdmin/viewDocuments');?>" class="count">179</a>
                <h3>Total Registrar Documents</h3>
                <a href="<?php echo base_url('ManageAdmin/viewDocuments');?>">&nbsp; &nbsp; View Details</a>
              </div>
            </div>
          </div>  
          <!-- /top tiles -->
