...
<<<<<<< HEAD:application/views/profileAdmin.php
                ...
                <li ><a href="<?php echo base_url('DocumentDraft/viewDraft'); ?>"><span class="glyphicon glyphicon-folder-open"></span><span>&nbsp; Draft </span></a></li>                         
                <li><a href="#"><span class="glyphicon glyphicon-book"></span><span>&nbsp; Guide </span></a></li>              
                <li><a href="<?php echo base_url('ManageAdmin/viewmsgtoAdmin');?>"><span class="glyphicon glyphicon-map-marker"></span><span>&nbsp; User Reviews </span></a></li>
...
<<<<<<< HEAD:application/views/profile_admin.php
=======
>>>>>>> master:application/views/profile_admin.php
>>>>>>> cabuang:application/views/profileAdmin.php
